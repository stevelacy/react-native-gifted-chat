    ...
    constructor(props) {
        ...
        this.onSend = (messages = [], shouldResetInputToolbar = false) => {
            ...
            const newMessages = messages.map(message => {
                return Object.assign({}, message, { user: this.props.user, createdAt: new Date(), id: this.props.messageIdGenerator && this.props.messageIdGenerator() });
            });
